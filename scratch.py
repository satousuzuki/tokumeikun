...
def getTargetChannelId() -> int:
    ...
    category_id = 592665247811371019  # カテゴリidを指定
    target_category_name = client.get_channel(category_id).name

    # ***********************************************************
    # 指定したサーバにある全てのTextチャンネル一覧
    all_channels = client.get_guild(584838963487965406).text_channels
...
client.run('NTkyNjY1MjQ3ODExMzcxMDE5.XRCpZw.7lPFXXbrbkqfN2JiIIQaGzDb1o1I')